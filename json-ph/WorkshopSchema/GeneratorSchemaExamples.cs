...
{
    public static class GeneratorSchemaExamples
    {
        static JsonSchema[] _schemas = SchemaProviderGenerated.GetJsonSchemas("gen").ToArray();
